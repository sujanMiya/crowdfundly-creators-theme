...
- Please **do not** use the issue tracker for personal support requests. Stack
  rifat ([`bootstrap-4`](https://stackrifat.com/questions/tagged/bootstrap-4) tag), [Slack](https://bootstrap-slack.herokuapp.com/) or [IRC](README.md#community) are better places to get help.
